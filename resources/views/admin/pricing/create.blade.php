        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Thêm mới Pricing</h3>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="seat_type" id="seat_type" class="form-control @error('seat_type') is-invalid @enderror" required>
                                        ...
                                        <option value="Normal" {{ old('seat_type') == 'Normal' ? 'selected' : '' }}>Thường</option>
                                        <option value="VIP" {{ old('seat_type') == 'VIP' ? 'selected' : '' }}>VIP</option>
                                        <option value="Couple" {{ old('seat_type') == 'Couple' ? 'selected' : '' }}>Đôi</option>
                                    </select>
                                    @error('seat_type')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="day_type" id="day_type" class="form-control @error('day_type') is-invalid @enderror" required>
                                        ...
                                        <option value="Weekday" {{ old('day_type') == 'Weekday' ? 'selected' : '' }}>Ngày thường</option>
                                        <option value="Weekend" {{ old('day_type') == 'Weekend' ? 'selected' : '' }}>Cuối tuần</option>
                                        <option value="Holiday" {{ old('day_type') == 'Holiday' ? 'selected' : '' }}>Ngày lễ</option>
                                    </select>
                                    @error('day_type')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="time_slot" id="time_slot" class="form-control @error('time_slot') is-invalid @enderror" required>
                                        ...
                                        <option value="Morning" {{ old('time_slot') == 'Morning' ? 'selected' : '' }}>Sáng (6:00 - 12:00)</option>
                                        <option value="Afternoon" {{ old('time_slot') == 'Afternoon' ? 'selected' : '' }}>Chiều (12:00 - 18:00)</option>
                                        <option value="Evening" {{ old('time_slot') == 'Evening' ? 'selected' : '' }}>Tối (18:00 - 22:00)</option>
                                        <option value="Late Night" {{ old('time_slot') == 'Late Night' ? 'selected' : '' }}>Đêm khuya (22:00 - 6:00)</option>
                                    </select>
                                    @error('time_slot')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
