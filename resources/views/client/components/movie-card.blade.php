...
<article class="movie-card h-100 d-flex flex-column overflow-hidden">
    <div class="movie-card__media position-relative">
        <img src="{{ movie_poster_url($movie['poster_url'] ?? null) }}" class="img-fluid w-100" alt="{{ $movie['title'] }}" onerror="this.onerror=null; this.src='{{ asset('assets/img/default/cinema.jpg') }}';">
